...
public class HttpServerUtils {
    ...
    public static String getUserNameOfSession(HttpExchange t) {
        Object userName = t.getAttribute(com.jaume.constants.HttpServer.Session.USERNAME_LOGED_ATTRIBUTE);
        return userName != null ? userName.toString() : null;
    }

    public static String getSessionToken(HttpExchange t) {
        Object sessionToken = t.getAttribute(com.jaume.constants.HttpServer.Session.SESSION_TOKEN_ATTRIBUTE);
